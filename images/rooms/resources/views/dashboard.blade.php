...
<head>
    ...
    <title>Dashboard - TrackAsset</title>
    <!-- Link to custom CSS -->
        ...
        <div class="main-wrapper">
            ...
            <main class="content-area">
                ...
                <div class="dashboard-grid">
                    ...
                    <!-- CARD 1: New Inventories Reported -->
                    <div class="stat-card card-blue">
                        <h3 class="card-header">
                            <svg class="card-icon text-blue" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M12 4v16m8-8H4"></path>
                            </svg>
                            New Inventories Reported
                        </h3>
                    ...
                    <!-- CARD 2: New Users Registered -->
                    <div class="stat-card card-purple">
                        <h3 class="card-header">
                            <svg class="card-icon text-purple" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <ul class="user-list" id="new-users-list">
                            <!-- Populated by JS -->
                        </ul>
                    </div>

                    <!-- CARD 3: Problems Detected on Inventories -->
                    <div class="stat-card card-red">
                        <h3 class="card-header">
                            <svg class="card-icon text-red" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <div class="table-responsive">
                            <table class="data-table">
                                ...
                                <tbody id="problem-inventories-body">
                                    <!-- Populated by JS -->
                                </tbody>
                            </table>
                        </div>
                    ...
                    <!-- CARD 4: Total Inventories Registered (Chart) -->
                    <div class="stat-card card-green">
                        <h3 class="card-header">
                            <svg class="card-icon text-green" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M11 3.055A9.001 9.001 0 1020.945 13H11V3.055z"></path>
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M20.488 9H15V3.512A9.025 9.025 0 0120.488 9z"></path>
                            </svg>
                            Total Inventories Status
                        </h3>

                        <div class="chart-wrapper" id="chart-wrapper">
                            <!-- Circular Chart -->
                            <div class="chart-circle" id="chart-circle">
                                <!-- Inner Circle for Donut Effect -->
                                <div class="chart-inner">
                                    <span class="chart-total" id="chart-total-label">0</span>
                                    <span class="chart-label">Total Items</span>
                                </div>
                            </div>
