...
<head>
    ...
    <title>Add Room - TrackAsset</title>
    <!-- Link to custom CSS -->
    <link rel="stylesheet" href="{{ asset('css/add_rooms.css') }}?v={{ time() }}">
    <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
    <script src="{{ asset('js/dashboard.js') }}?v={{ time() }}"></script>
    <script src="{{ asset('js/add_rooms.js') }}?v={{ time() }}"></script>
...
<body>
        ...
        <div class="main-wrapper">
            ...
            <main class="content-area">
                <div class="form-container">
                    <h3 class="form-title">Add Room</h3>

                    <form id="add-room-form" action="{{ route('rooms.store') }}" method="POST"
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-group" style="display: flex; flex-direction: column; align-items: center;">
                                <div id="room-image-wrapper" class="image-upload-wrapper" style="cursor: pointer;">
                                    <img src="{{ asset('images/rooms/default.png') }}" alt="Preview"
                                        class="image-preview" id="preview-img">
                                    ...
                                    <input type="file" name="room_photo" id="room_photo_input" class="file-input-hidden"
                                        style="display: none;">
                                </div>
                            </div>
                            ...
                            <div style="display: flex; flex-direction: column; gap: 1.5rem;">
                                <div>
                                    ...
                                    <input type="text" name="room_name" class="form-input" required>
                                </div>
    ...
    <script>
        // Room Image Preview Script (Robust with Unique IDs)
