...
<head>
    ...
    <title>Add Inventory - TrackAsset</title>
    <!-- Link to custom CSS -->
    ...
    <script src="{{ asset('js/add_inventory.js') }}?v={{ time() }}" defer></script>
        ...
        <div class="main-wrapper">
            ...
            <main class="content-area">
                <div class="form-container">
                    <h3 class="form-title">New Inventory Item</h3>
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-group">
                                ...
                                <div class="image-upload-wrapper">
                                    <img src="{{ asset('images/inventory/default.png') }}" alt="Preview"
                                        class="image-preview">
                            ...
                            <div style="display: flex; flex-direction: column; gap: 1.5rem;">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="inventory_name" class="form-input"
                                        placeholder="e.g. MacBook Pro M1" required>
                                </div>
                                ...
                                <div id="remarks-group" style="display: none;">
                                    ...
                                    <textarea name="remarks" class="form-input"
                                        placeholder="Please specify the issue..." rows="3"></textarea>
                                </div>
                            </div>
                        </div>
